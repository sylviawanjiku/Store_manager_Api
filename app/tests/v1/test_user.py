...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user_data ={'username':'sylvia','first_name':'Sylvie','last_name':'Mbugua','email':'sylviawanjiku@gmail.com','password':23445233}
        self.user_data_empty_email ={'username':'sylvia','first_name':'Sylvie','last_name':'Mbugua','email':'','password':23445266}
        self.user_data_empty_firstname ={'username':'sylvia','first_name':'','last_name':'Mbugua','email':'','password':23445277}
        self.user_data_empty_lastname ={'username':'sylvia','first_name':'Sylvie','last_name':'','email':'','password':23445277}
        self.user_data_empty_username ={'username':'','first_name':'Sylvie','last_name':'','email':'','password':23445255}

    def test_register_user(self):
        '''Test API can create a new user (POST request)'''
        new_user = self.client.post('/api/v1/users',data = self.user_data) 
        # user = json.loads(new_user.data.decode('utf-8'))
